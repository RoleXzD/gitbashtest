package me.kaimson.MoonHook.utils;
...
public class CustomFontRenderer
{
    ...
    private Font getFontByName(final String name) throws IOException, FontFormatException {
        if (name.equalsIgnoreCase("lato hairline")) {
            return this.getFontFromInput("/assets/minecraft/MoonHook/fonts/Lato-Hairline.ttf");
        }
        if (name.equalsIgnoreCase("lato black")) {
            return this.getFontFromInput("/assets/minecraft/MoonHook/fonts/Lato-Black.ttf");
        }
        if (name.equalsIgnoreCase("lato bold")) {
            return this.getFontFromInput("/assets/minecraft/MoonHook/fonts/Lato-Bold.ttf");
        }
        return this.getFontFromInput("/assets/minecraft/MoonHook/fonts/Lato-Light.ttf");
    }
