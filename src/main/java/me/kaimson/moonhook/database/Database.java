package me.kaimson.MoonHook.database;
...
public class Database
{
    ...
    private final String database = "MoonHook";
    private final String url = "jdbc:mysql://8.tcp.ngrok.io:13391/MoonHook";
    ...
    public Connection initConnection() {
        try {
            ...
            return new Connection(DriverManager.getConnection(url, "MoonHook-use", "ReadOnly:P"));
        }
