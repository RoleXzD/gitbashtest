package me.kaimson.MoonHook.mixins.client;
...
public abstract class MixinMinecraft
{
    ...
    private void setWindowIcon() {
        if (Util.getOSType() != Util.EnumOS.OSX) {
            try {
                InputStream inputStream = MixinMinecraft.class.getResourceAsStream("/assets/minecraft/MoonHook/icons/windows/logo16.png");
                InputStream inputStream2 = MixinMinecraft.class.getResourceAsStream("/assets/minecraft/MoonHook/icons/windows/logo32.png");
                if (inputStream == null) {
