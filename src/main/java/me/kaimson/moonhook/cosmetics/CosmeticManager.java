package me.kaimson.MoonHook.cosmetics;

import me.kaimson.MoonHook.*;
import me.kaimson.MoonHook.database.*;
                    ...
                    if (result != null) {
                        while (result.next()) {
                            ...
                            if (cosmeticList.contains(CosmeticList.CAPES)) {
                                ...
                                capeTexture = new ResourceLocation(sb.append("MoonHook/capes/").append(getCapeName(data)).append(".png").toString());
                            }
                            else {
                                capeTexture = null;
                            }
