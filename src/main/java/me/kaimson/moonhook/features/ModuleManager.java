package me.kaimson.MoonHook.features;
...
public class ModuleManager
{
    ...
    public void init() {
        final Set<Class<? extends Module>> modules = new Reflections("me.kaimson.MoonHook.features.modules").getSubTypesOf(Module.class);
