...
import me.kaimson.MoonHook.discord.*;
import me.kaimson.MoonHook.cosmetics.*;
import net.minecraft.client.gui.*;
import me.kaimson.MoonHook.features.modules.*;
import me.kaimson.MoonHook.gui.utils.blur.*;
import me.kaimson.MoonHook.gui.settings.*;
import me.kaimson.MoonHook.config.*;
import me.kaimson.MoonHook.features.modules.utils.*;
import me.kaimson.MoonHook.utils.*;
import me.kaimson.MoonHook.features.*;
import me.kaimson.MoonHook.gui.utils.*;
...
public class Client
{
    ...
    static {
        ...
        dir = new File(Minecraft.getMinecraft().mcDataDir, "MoonHook");
        LOGO = new ResourceLocation("moonhook/logo.png");
        BACKGROUND = new ResourceLocation("moonhook/bg.png");
        TRANSPARENT = new ResourceLocation("moonhook/transparent.png");
